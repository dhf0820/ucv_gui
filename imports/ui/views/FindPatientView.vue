  ...
  <div>
    <div class="custom-container">
      <div class="d-flex justify-content-between">
        <b-breadcrumb class="mb-0 breadcrumb activeBreadcrumb" :items="breadcrumbs"></b-breadcrumb>
        <b-breadcrumb class="mb-0 breadcrumb" :items="practiceBreadcrumbs"></b-breadcrumb>
      </div>
...
export default {
  ...
  methods: {
    ...
    allowSearch() {
      // const { identifier, lastName } = this?.formData;e
